...
export default function ReceiptViewer({
  ...
  const handleDownloadPDF = async () => {
    try {
      ...
      // Capture receipt using modern-screenshot with high quality
      ...
      // Save PDF
      pdf.save(`Payment_Receipt_${order.orderNumber}.pdf`);
    } catch (err) {
  ...
  const handlePrint = () => {
    try {
      ...
      // Copy the receipt content to the print window
  ...
  return (
    <div className={className}>
      ...
      {/* Action Toolbar */}
      <div className="flex gap-4 mb-6 receipt-toolbar print:hidden">
        <Link
          href="/orders"
      ...
      {/* Error Message */}
      {error && (
        <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded text-red-700 text-sm receipt-error print:hidden">
      ...
      {/* Receipt Template */}
      <div id="receipt-template" style={{ display: 'inline-block' }}>
