      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.p
            ...
            className="text-base md:text-lg lg:text-xl text-gray-400 max-w-2xl mx-auto"
          >
          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative p-6 md:p-8 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm overflow-hidden"
              >
                ...
                <motion.div
                  ...
                  className={`relative w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 bg-gradient-to-br ${feature.gradient} rounded-2xl flex items-center justify-center mb-4 md:mb-6 shadow-lg`}
                >
                  <Icon className="text-white w-6 h-6 md:w-7 md:h-7 lg:w-8 lg:h-8" />
                </motion.div>

                {/* Content */}
                <h3 className="relative text-lg md:text-xl lg:text-2xl font-bold text-white mb-3 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-400 group-hover:to-purple-400 transition-all duration-300">
                  {feature.title}
                </h3>
                <p className="relative text-sm md:text-base text-gray-400 leading-relaxed group-hover:text-gray-300 transition-colors duration-300">
                  {feature.description}
                </p>
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="px-6 py-3 md:px-8 md:py-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-semibold rounded-full shadow-lg hover:shadow-blue-500/50 transition-all duration-300 text-sm md:text-base"
          >
